...
const router = t.router({
  dashboard: {
    ...
    getWidgets: procedure.output(z.string().array()).query(async (opt) => {
      return await opt.ctx.instance.sys.settings.getUserApplicationSetting<StringListApplicationSetting>(opt.ctx.userId, "uk.ewsgit.dashboard", "widgets");
    }),
    getWelcomeMessage: procedure
      .input(z.number())
      .output(z.string().or(z.undefined()))
      .query(async (opt) => {
        if (await opt.ctx.instance.sys.settings.getUserApplicationSetting<BooleanApplicationSetting>(opt.ctx.userId, "uk.ewsgit.dashboard", "show_greeting")) {
    ...
    getShowSearchBar: procedure.output(z.boolean()).query(async (opt) => {
      return await opt.ctx.instance.sys.settings.getUserApplicationSetting<BooleanApplicationSetting>(opt.ctx.userId, "uk.ewsgit.dashboard", "show_search_bar");
    }),
...
instance.sys.event.on(WorkspacesEvent.BeforeStartupComplete, () => {
  ...
  instance.sys.settings.registerApplicationSetting(
    new BooleanApplicationSetting("uk.ewsgit.dashboard", "content_background", true)
  ...
  instance.sys.settings.registerApplicationSetting(
    new StringListApplicationSetting("uk.ewsgit.dashboard", "widgets", ["user.profile"])
  ...
  instance.sys.settings.registerApplicationSetting(
    new BooleanApplicationSetting("uk.ewsgit.dashboard", "show_edit_button", true)
  ...
  instance.sys.settings.registerApplicationSetting(
    new BooleanApplicationSetting("uk.ewsgit.dashboard", "show_search_bar", false)
  ...
  instance.sys.settings.registerApplicationSetting(
    new BooleanApplicationSetting("uk.ewsgit.dashboard", "open_search_in_new_tab", false)
  ...
  instance.sys.settings.registerApplicationSetting(
    new StringApplicationSetting("uk.ewsgit.dashboard", "search_bar_search_engine", "https://duckduckgo.com/?q=%s")
