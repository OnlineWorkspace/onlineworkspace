...
import { type Component, createEffect, createResource, For, Match, onCleanup, onMount, Suspense, Switch, useContext } from "solid-js";
                  ...
                  onClick={() => {
                    selectFilesForUpload(async (files) => {
                      for (const file of files) {
                        ...
                        viewCtx!.setActiveTasks([...viewCtx!.activeTasks(), { taskId: taskUUID, message: `Uploading file '${file.name}'` }]);
