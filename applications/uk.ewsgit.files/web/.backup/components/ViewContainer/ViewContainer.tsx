import UKContextMenu from "@ewsgit/uikit-solid/src/components/contextMenu/UKContextMenu.tsx";
        ...
        menu={<UKMenu items={[
          viewCtx!.cutItems().length > 0 || viewCtx!.copyItems().length > 0
            ? {
              ...
              async onClick() {
                const copyItems = viewCtx!.copyItems();
                      ...
                      if (path.join(item, "..") === params.currentPath || "") {
                        newPath = path.join(
                          ...
                          ` (${viewCtx!
                            ...
                            .filter((i) =>
                              i.path.startsWith(
                                path.join(params.currentPath, path.basename(item)),
                              ),
                            ).length
                          })`,
                        );
                ...
                const cutItems = viewCtx!.cutItems();
