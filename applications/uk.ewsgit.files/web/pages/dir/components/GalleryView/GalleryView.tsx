    ...
    <div class={styles.page}>
      <div class={styles.galleryHeader}>
        ...
        <div class={styles.galleryPreviewMain}>
          <div>
            <UKText size="l" role="label">Filename.ext</UKText>
          </div>
          <img class={styles.galleryPreviewMainImage} style={{"aspect-ratio": `${galleryPreviewMainImage()?.dimensions?.width} / ${galleryPreviewMainImage()?.dimensions?.height}`}} alt="" src={galleryPreviewMainImage()?.image || "/assets/generic_background.svg"} />
        </div>
        <div class={styles.galleryItems}>
          <div class={styles.galleryItem}></div>
          <div class={styles.galleryItem}></div>
