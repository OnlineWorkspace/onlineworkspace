        ...
        <UKSideBar
          items={[
            ...
            },
            {
              ...
              active: location.pathname.startsWith("/app/uk.ewsgit.settings/profile"),
            },
            {
              type: "button",
              ...
              active: location.pathname.startsWith("/app/uk.ewsgit.settings/authentication"),
            },
            {
              type: "button",
              ...
              active: location.pathname.startsWith("/app/uk.ewsgit.settings/storage"),
            },
            {
              type: "button",
              ...
              active: location.pathname.startsWith("/app/uk.ewsgit.settings/customization"),
            },
            {
              type: "button",
              ...
              active: location.pathname.startsWith("/app/uk.ewsgit.settings/applications"),
            },
            isAdministrator()
              ? {
                type: "button",
